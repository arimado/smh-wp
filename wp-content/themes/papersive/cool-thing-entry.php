...
<div class="latest-thing-main">
	<div class="latest-thing-main-img"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php if (class_exists('MultiPostThumbnails')) : MultiPostThumbnails::the_post_thumbnail(get_post_type(), 'cool-thing-image'); endif; ?></a> </div>
